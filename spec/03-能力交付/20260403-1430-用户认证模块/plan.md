...
后端全局架构已完成脚手架搭建（[[../../02-技术设计/20260402-1616-后端全局架构设计/summary|架构设计总结]]），6 个 Auth 端点已注册但均返回 `501 Not Implemented`。本 Spec 将实现用户认证的完整业务逻辑，是所有后续模块（教师、预约、支付等）的前置依赖。
...
- 架构设计 Spec: [[../../02-技术设计/20260402-1616-后端全局架构设计/plan|后端全局架构设计]]
