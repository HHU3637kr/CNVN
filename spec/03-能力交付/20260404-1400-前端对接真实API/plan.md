...
tags:
  ...
  - api
related:
  - "[[../../02-技术设计/20260402-1616-后端全局架构设计/plan|后端全局架构设计]]"
  - "[[../../01-产品规划/20260330-1650-CNVN中越通项目PRD/plan|PRD]]"
---
...
后端已实现认证、教师、预约、钱包、评价、课堂消息等模块（参见 [[../../02-技术设计/20260402-1616-后端全局架构设计/summary|架构设计总结]]）。前端 **`Classroom.tsx` 已对接** `GET /auth/me`、`GET /lessons/{id}/messages` 与 WebSocket；**首页、教师列表/详情、学生/教师仪表盘**仍以 **Mock 或静态 JSX** 为主，与 [[../../02-技术设计/20260402-1616-后端全局架构设计/plan|全局架构]] 中「后续工作：前端对接」一致。
...
- 架构设计: [[../../02-技术设计/20260402-1616-后端全局架构设计/plan|后端全局架构设计]]
- PRD: [[../../01-产品规划/20260330-1650-CNVN中越通项目PRD/plan|产品需求文档]]
