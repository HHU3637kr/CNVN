...
| EXP-003 | Alembic 迁移版本号长度与空库验证 | CNVN, Alembic, migration, revision, 空库验证, PostgreSQL | 新增或修改 Alembic migration | revision/down_revision 保持 ≤32 字符，并用独立临时空库执行 `alembic upgrade head` |
